---
title: "redis在go中的实践"
description: "这篇文章记录了我在学习极客时间大明老师课程后，对 Redis 在 Go 项目中的实践总结。从初始化 Redis 客户端，到在仓储层引入缓存模块，再到结合 DDD 思想实现数据查询与缓存的解耦，逐步形成了更优雅的使用方式。"
pubDate: 2025-08-31
updatedDate: 2025-08-31
category: "技术"
tags: ["redis","ddd"]
thumbnail: "/blog/redis-in-golang-practice.jpg"
isTop: false
draft: false
slug: "redis-in-golang-practice"
---
